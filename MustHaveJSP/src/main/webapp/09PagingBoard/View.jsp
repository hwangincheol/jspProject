...
BoardDAO dao = new BoardDAO(application);	//DAO 객체 생성 jdbc연결
dao.updateVisitCount(num);	//조회수 증가(메서드 활용하여 db에 조회수 값 증가)
BoardDTO dto = dao.selectView(num);	//게시물 가져오기(번호를 넣어서 객체를 만듬)
dao.close();	//DB 연결 해제
%>
<!DOCTYPE html>
<html>
...
<body>
	...
	<!-- List.jsp 에서 View.jsp?num=번호 로 넘어온 요청을 자세히 보기 페이지로 출력 -->
